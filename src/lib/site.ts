 ...
 */
export const SITE_NAME = "aloll0";

export const SITE_TAGLINE = "Love your gut. Love your life.";

export const SITE_DESCRIPTION =
  "aloll0 is a gut-friendly soda with 3–5g sugar, 9g fiber, prebiotics, and probiotics in every can. Five bold flavors, real fruit juice, and no artificial sweeteners—refreshment that loves you back.";
